...
function home({value}) {
  ...
  return (
    ...
    <Header/>
      ...
      <h2 className='Nome msg'>Convidam você <h2 className='nomeCon'>{value}</h2> e sua familia  para cerimônia de seu casamento civil.</h2>
      <div className='date'>
      <h1 className='Nome mes'>Novembro </h1>
      <h2 className='Nome data'>Sexta<span className='numeral'>03</span> ás 14:30hrs</h2>
